...
{
JOptionPane.showConfirmDialog(null, "Invalid or empty Monthly Payment entry.Please correct.", "Payment Input Error", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE);
return;
}
if (interest == 0)
{
